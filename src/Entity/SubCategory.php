...
#[UniqueEntity(fields: ['name', 'category'], message: 'Cette sous-catégorie existe déjà dans cette catégorie.')]
...
class SubCategory
{
    ...
    #[Assert\NotNull(message: 'La catégorie parent est obligatoire.')]
    #[Groups(['subcategory:read', 'product:read'])]
